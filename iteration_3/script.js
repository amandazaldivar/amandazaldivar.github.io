$(document).ready(function(){ 
  ...
  $.getJSON("http://api.openweathermap.org/data/2.5/weather?zip=10003,us&appid=462d4c055e82a152627b26a462c1a793",function(result){
 ...
 function drawGridObjects(w){
  ...
  function rotateGridObjects(second){
    var now = new Date();
    var second = now.getSeconds();
